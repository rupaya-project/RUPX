...
var (
	RupayaMainnetGenesisHash = common.HexToHash("6f4694b2e15bc96fd67b70dce128c26a5f3519909bdcde3bf81220715197dc0f") // Rupaya Mainnet genesis hash to enforce below configs on
...
var (
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllPosvProtocolChanges   = &ChainConfig{big.NewInt(499), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, &PosvConfig{Period: 0, Epoch: 30000}}
...
func (c *ChainConfig) IsTIPRupeX(num *big.Int) bool {
	if common.IsTestnet {
		return isForked(common.TIPRupeXTestnet, num)
	} else {
		return isForked(common.TIPRupeX, num)
	}
}

func (c *ChainConfig) IsTIPRupeXLending(num *big.Int) bool {
	return isForked(common.TIPRupeXLending, num)
}
