...
import (
	...
	"github.com/rupaya-project/rupx/eth/filters"
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call rupaya.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) CallContractWithState(call rupaya.CallMsg, chain consensus.ChainContext, statedb *state.StateDB) ([]byte, error) {
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call rupaya.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call rupaya.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call rupaya.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
	// Ensure message is initialized properly.
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query rupaya.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query rupaya.FilterQuery, ch chan<- types.Log) (rupaya.Subscription, error) {
