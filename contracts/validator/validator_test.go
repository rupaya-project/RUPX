...
func TestRewardBalance(t *testing.T) {
	...
	// validatorAddr, _, baseValidator, err := contract.DeployRupayaValidator(transactOpts, contractBackend, big.NewInt(50000), big.NewInt(99), big.NewInt(100), big.NewInt(100))
	validatorCap := new(big.Int)
	validatorCap.SetString("50000000000000000000000", 10)
	validatorAddr, _, baseValidator, err := contractValidator.DeployRupayaValidator(
		transactOpts,
		contractBackend,
		[]common.Address{addr},
...
func GetRewardBalancesRate(foudationWalletAddr common.Address, masterAddr common.Address, totalReward *big.Int, validator *contractValidator.RupayaValidator) (map[common.Address]*big.Int, error) {
...
func GetCandidatesOwnerBySigner(validator *contractValidator.RupayaValidator, signerAddr common.Address) common.Address {
	owner := signerAddr
	opts := new(bind.CallOpts)
